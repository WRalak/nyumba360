    ...
    async () => {
      ...
      return {
        ...
        stats: {
          ...
          totalUnits: propertiesRes.data.properties?.reduce((sum, prop) => sum + (prop.total_units || 0), 0) || 0,
          occupiedUnits: propertiesRes.data.properties?.reduce((sum, prop) => sum + (prop.stats?.occupied_units || 0), 0) || 0,
          totalTenants: tenantsRes.data.totalTenants || 0,
          monthlyRevenue: paymentsRes.data.monthlyRevenue || 0,
          pendingMaintenance: maintenanceRes.data.pendingCount || 0,
          collectionRate: paymentsRes.data.collectionRate || 0
        }
      };
    },
    {
